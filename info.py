...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Kunjumon:OIzyqnEsnodg3PDs@kunjupanic.dnd9mag.mongodb.net/?retryWrites=true&w=majority"")
DATABASE_NAME = environ.get('DATABASE_NAME', "kunjumon")
